...
if(isset($_POST['submit']))
{
    ...
    $phone=$_POST['phone'];
    $sql= "
        INSERT INTO `users`(`id`, `fullname`, `username`, `password`, `email`, `address`, `phone`) 
        VALUES (NULL,'".$cusName."','".$userName."','".$password."','".$email."', '".$address."','".$phone."')
    ";
                    ...
                    <form id="signupform" class="form-horizontal" role="form" action='' method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-offset-3 col-md-9">
                                <button id="btn-signup" type="submit" class="btn btn-info" name="submit">Đăng ký</button>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12 control">
                                <div style="border-top: 1px solid#888; padding-top:15px; font-size:70%">
                                    Bạn có tài khoản!
                                    <a id="signinlink" href="login.php">
                                        Đăng nhập
                                    </a>
                                </div>
                            </div>
